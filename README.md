# gemini-rag-ragas-eval
gemini rag project with ragas evaluation

#### Local directory init with UV

```git clone https://github.com/spha-code/gemini-rag-ragas-eval.git```

```cd gemini-rag-ragas-eval```
